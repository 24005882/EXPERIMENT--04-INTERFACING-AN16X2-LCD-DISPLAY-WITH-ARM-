...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "A.LAHARI \n");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212223230111\n");
}
void SystemClock_Config(void)
{
...
## Output screen shots of proteus  :
 <img width="1111" height="639" alt="image" src="https://github.com/user-attachments/assets/5d8733a7-c83d-4cd3-9340-76ede1b9b52a" />

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 <img width="1205" height="953" alt="image" src="https://github.com/user-attachments/assets/366bb621-154e-4734-8ca2-a7402987a857" />
